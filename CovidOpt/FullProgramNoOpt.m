...
Yo = [329500000; initI' ;0];%% Initial S, I1, I2,... In, R
...
dSdt = -sum(beta * (S/N) .* I')+lOI*R; % evolution of susceptible. for seasonal add "+lOI*R" and define loI- loss of immunity rate
